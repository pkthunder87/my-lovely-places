function Step({
  ...
  return (
    <section className=" col-span-2 grid grid-cols-2" aria-label={ariaLabel}>
      <div
        className={`firefox:text-[3.4rem] relative col-span-2 h-[50dvw] w-full bg-cream text-[2.4rem] leading-[1.3em] sm:col-span-1 sm:h-[50dvw] sm:w-[50dvw] sm:text-[4.5rem] ${textColor}`}
      >
        <div className="absolute left-1/2 top-[46%] -translate-x-1/2 -translate-y-1/2  transform text-center sm:top-1/2 sm:text-left">
          <p>
            Step{' '}
            <span className="firefox:text-6xl text-5xl sm:text-[6rem]">
              {stepNum}
            </span>
          </p>
